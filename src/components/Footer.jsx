                ...
                <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-gray-800 rounded-lg overflow-hidden">
                            <img src={`${process.env.PUBLIC_URL}/images/ieee-logo.png`} alt="IEEE-logo" className="w-full h-48 object-cover" />
                            <div className="p-4">
                                <p className="text-sm text-gray-300 text-center">IEEE</p>
                            </div>
                        </div>
                        <div className="bg-gray-800 rounded-lg overflow-hidden">
                            <img src={`${process.env.PUBLIC_URL}/images/mangdang-logo.png`} alt="mangdang-logo" className="w-full h-48 object-cover" />
                            <div className="p-4">
                                <p className="text-sm text-gray-300 text-center">MangDang</p>
                            </div>
                        </div>
                        <div className="bg-gray-800 rounded-lg overflow-hidden">
                            <img src={`${process.env.PUBLIC_URL}/images/ieee-r1r2-better-together.jpg`} alt="region1-2-logo" className="w-full h-48 object-cover" />
                            <div className="p-4">
